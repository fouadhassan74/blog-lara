...
<div class="container sm:grid grid-cols-2 gap-15 mx-auto py-15 px-5 border-b border-gray-300">
    <a href="{{route('blog.create')}}" class="bg-green-700 text-gray-100 py-4 px-5 rounded-lg font-bold uppercase text-l place-self-start">Create Post</a>
</div>
@endif
<div class="container sm:grid grid-cols-2 gap-15 mx-auto py-15 px-5 border-b border-gray-300">
@foreach ($posts as $post)
    ...
    <div>
        ...
        <span>
            ...
            <a href="{{route('blog.show',['post'=>$post->id])}}" class="bg-gray-700 text-gray-100 py-4 px-5 rounded-lg font-bold uppercase text-l place-self-start">Read More</a>
        </span>
    </div>
